 ...
 * This module is imported at server startup (via next.config.js) so that the
 * application refuses to boot when required variables are absent or malformed.
 *
 * Usage:
...
const envSchema = z.object({
  ...
  /** Public base URL of the application, e.g. https://shipforge.dev */
  APP_URL: z.string().url('APP_URL must be a valid URL'),

  /** Same URL exposed to the browser (Next.js NEXT_PUBLIC_ prefix). */
